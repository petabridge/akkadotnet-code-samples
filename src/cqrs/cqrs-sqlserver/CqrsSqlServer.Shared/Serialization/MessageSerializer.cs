...
using CqrsSqlServer.Shared.Serialization.Proto;
using Google.Protobuf;
using Google.Protobuf.WellKnownTypes;
using CreateProduct = CqrsSqlServer.Shared.Commands.CreateProduct;
using FetchAllProductsImpl = CqrsSqlServer.Shared.Queries.FetchAllProductsImpl;
using FetchAllProductsResponse = CqrsSqlServer.Shared.Queries.FetchAllProductsResponse;
using FetchSoldProductsImpl = CqrsSqlServer.Shared.Queries.FetchSoldProductsImpl;
using FetchSoldProductsResponse = CqrsSqlServer.Shared.Queries.FetchSoldProductsResponse;
using FetchWarningEventsImpl = CqrsSqlServer.Shared.Queries.FetchWarningEventsImpl;
using FetchWarningEventsResponse = CqrsSqlServer.Shared.Queries.FetchWarningEventsResponse;
using FetchProduct = CqrsSqlServer.Shared.Queries.FetchProduct;
using InventoryChangeReason = CqrsSqlServer.Shared.Events.InventoryChangeReason;
using ProductCreated = CqrsSqlServer.Shared.Events.ProductCreated;
using ProductSold = CqrsSqlServer.Shared.Events.ProductSold;
using ProductWarningReason = CqrsSqlServer.Shared.Events.ProductWarningReason;
using SupplyProduct = CqrsSqlServer.Shared.Commands.SupplyProduct;
